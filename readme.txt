...
= What's New? =
New in version 2.1:
- New customizations for search results pages
...
= Custom Templates =
Simple Directory comes with three templates: single-listing.php, archive-listing.php and search-listing.php.
...
== Changelog ==
= 2.1.2=
Bug fix for custom CSS.
= 2.1 =
Improved loading of custom CSS. New settings for search result pages.
= 2.0.2 =
Fixed bug with new settings.  Updated version compatibility.
= 2.0.1 =
Fixed search results template.  Added new settings to disable included templates.
= 2.0 =
Improved layouts to template files.  Improved help tabs.  Reorganization of some settings.
= 1.6.7 =
Bug fixes to archive-listing.php and simple-directory.php
= 1.6.6 =
Maintenance release.  Removed unnecessary files and functions.
= 1.6.4 =
Removed self-referencing link in title of single listings.
= 1.6.1 =
Critical bug fix.
= 1.6 =
...
= 1.5.1 =
Listing email now displays in social icon row on premium listings.  Updated POT file.
= 1.5 =
...
== Upgrade Notice ==
= 2.1.2 =
Fixes to settings output.
= 2.0.1 =
Fixes to search results template.  Added ability to disable built in templates.
= 1.6.7 =
Bug fixes
= 1.6.6 =
Maintenance release.  Removed depricated files and functions.
= 1.6.1 =
...
= 1.5.2 =
Email address can now display on single listings.  Sidebar can now be displayed on Listing category pages.
= 1.5 =
