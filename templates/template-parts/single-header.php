...
if($m['listing_status'][0] == 'basic'){
  the_title('<span itemprop="name"><h1 class="single-title"><a href="'.esc_url(get_permalink()).'" rel="bookmark">','</a></h1></span>');
}
else{
  the_title('<span itemprop="name"><h1 class="single-title"><a href="'.esc_url(get_permalink()).'" rel="bookmark">','&nbsp;<i class="fi-star"></i></a></h1></span>');
}?>
