...
piklist('field', array(
    'type'     => 'html'
    ,'field'   => 'sdir_archive_settings_description'
    ,'value'   => sprintf(__('Use these settings to adjust the appearance of the category pages.'))
));
...
piklist('field',array(
  ...
  ,'fields'   =>array(
    array(
    'type'      => 'text'
    ,'field'    => 'sdir_category_padding_top'
    ,'label'    => __('Top','simple-dir')
    ,'columns'  => 2
  )
  ,array(
    'type'      => 'text'
    ,'field'    => 'sdir_category_padding_right'
    ,'label'    => __('Left','simple-dir')
    ,'columns'  => 2
  )
  ,array(
    'type'      =>'text'
    ,'field'    =>'sdir_category_padding_bottom'
    ,'label'    =>__('Bottom','simple-dir')
    ,'columns'  =>2
  )
  ,array(
    'type'      => 'text'
    ,'field'    => 'sdir_category_padding_left'
    ,'label'    => __('Left','simple-dir')
    ,'columns'  => 2
  )
  )
