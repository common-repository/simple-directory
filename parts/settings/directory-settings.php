...
*/
 ...
 piklist ('field', array(
  ...
  piklist('field', array(
    'type'      => 'checkbox'
    ,'field'    => 'sdir_disable_templates'
    ,'label'    => __('Disable The Built-In Templates?','simple-dir')
    ,'help'     => __('You can use your own templates, or modify the included ones.  Select the built-in templates you want to disable.','simple-dir')
    ,'description'  => __('Most users should leave these boxes unchecked.')
    ,'choices'  => array(
      'single'   => __('Single Listings','simple-dir')
      ,'category'   => __('Listing Category Pages','simple-dir')
      ,'search'     => __('Listing Search Results','simple-dir')
    )
  ));
